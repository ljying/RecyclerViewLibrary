...
import ljying.github.io.swiperecyclerview.SwipeMenuAdapter;
...
public class SwipeAdapter extends SwipeMenuAdapter<SwipeAdapter.DefaultViewHolder> {
    ...
    public SwipeAdapter(List<String> titles) {
        this.titles = titles;
    }
    ...
    public View onCreateContentView(ViewGroup parent, int viewType) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.swipe_content_item, parent, false);
    }
